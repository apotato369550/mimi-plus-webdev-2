...
export default function HomepageRewardCard({
  icon,
  product,
  brand,
  description,
  ...
  return (
    <div className="flex flex-col px-6 py-5 border border-gray-300 rounded-[8px] shadow-sm h-fit w-[374px]">
      ...
      <p className="text-gray-600 max-w-[300px] pb-6">{description}</p>
